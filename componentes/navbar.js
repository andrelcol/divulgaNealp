class Navbar extends HTMLElement {
    ...
    connectedCallback() {
        const prevPath = window.location.origin === "https://andrelcol.github.io" ? '/divulgacao/' : '/';
    ...
    <div class="w3-top">
        <div class="w3-bar w3-white w3-wide w3-padding w3-card">
            <a href="javascript: TRANSLATION.redirect('', '#experimentos')" class="w3-bar-item w3-button">Divulgacao</a>

            <!-- Float links to the right. Hide them on small screens -->
            <div class="w3-right w3-hide-small w3-hide-medium">
                <a id="navFlag" href="javascript:void(0);" onclick="toggleNavFlag()"
                    class="w3-bar-item w3-button ">
                    <img id="select-flag" class="flag" src="${prevPath}assests/bandeiras/us-icon.png">
                </a>

                <a href="javascript: TRANSLATION.redirect('', '#experimentos')" class="w3-bar-item w3-button menu-experimentos">Experimentos</a>
            ...
            <div id="navSmall" class="w3-bar-block w3-hide w3-hide-large">
                <a href="javascript: TRANSLATION.redirect('', '#experimentos')" class="w3-bar-item w3-button menu-experimentos" onclick="toggleFunction()">Experimentos</a>
                ...
                <a href="javascript:void(0)" class="nav-lang-option us-option selected"
                    ...
                    <img class="flag" src="${prevPath}assests/bandeiras/us-icon.png">
                </a>
                <a href="javascript:void(0)" class="nav-lang-option pt-option"
                    onclick="changeSelectedLanguage('pt-BR');">
                    <img class="flag" src="${prevPath}assests/bandeiras/br-icon.png">
                </a>
            </div>
        </div>
